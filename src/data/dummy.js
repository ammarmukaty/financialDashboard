...
export const pieChartData = [
  { x: "Labour", y: 18, text: "Labour:18%" },
  { x: "Legal", y: 8, text: "Legal:8%" },
  { x: "Production", y: 15, text: "Production:15%" },
  { x: "License", y: 11, text: "License:11%" },
  { x: "Facilities", y: 18, text: "Facilities:18%" },
  { x: "Taxes", y: 14, text: "Taxes:14%" },
  { x: "Insurance", y: 16, text: "Insurance:16%" },
];
